...
import { sessionData, signOut } from './lib/firebase'
...
const FirebaseAuth = React.lazy(() => import('./components/FirebaseAuth'))
    ...
    <>
      <nav className='nav'>
        ...
        <div className='nav-end'>
          ...
          {sessionData.value && <Link to='#' onClick={signOut}>Sign out</Link>}
        </div>
      </nav>
